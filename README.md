...
3. **Follow** the on‑screen menu:
   ...
   - Use **`i`** (case‑insensitive) as shorthand for `-inf`, e.g., `1 i 3` representing row vector $\left( \matrix{ 1 & -\infty & 3 } \right)$.
   - Matrices: rows separated by commas, entries by spaces.  
     Example: `1 i 3, i 2 4, 5 6 i` representing $3\times 3$-matrix $\left( \matrix{ 1 & -\infty & 3 \\\\ -\infty & 2 & 4 \\\\  5 & 6 & -\infty} \right)$
